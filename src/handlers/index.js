...
const getComplimentFunction = require('./db/compliments/get-compliment').handler
const getUserComplimentFunction = require('./db/compliments/get-compliment-by-category-personality').handler;
